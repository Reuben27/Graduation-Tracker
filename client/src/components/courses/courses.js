...
function Courses() {
  return (
    <div className="bg-gray-500 p-10">
      <div className="flex justify-between max-w-4xl m-auto bg-gray-600 px-5 py-2 rounded-md">
        ...
        <button className="bg-blue-500 hover:bg-blue-700 m-3 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
          Save
        </button>
      </div>
